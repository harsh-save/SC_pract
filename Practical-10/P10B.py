...
class Fitness:
    ...
    def nextGeneration(currentGen, eliteSize, mutationRate,self): 
    ...
    def geneticAlgorithm(population, popSize, eliteSize, mutationRate, generations,self): 
    ...
    for i in range(0,25):
        ...
        geneticAlgorithm(self,population=cityList, popSize=100, eliteSize=20, mutationRate=0.01, generations=500)
    ...
    def geneticAlgorithmPlot(self,population, popSize, eliteSize, mutationRate, generations): 
        ...
        plt.show()
        self.geneticAlgorithmPlot(population=self.cityList, popSize=100, eliteSize=20, mutationRate=0.01, generations=500)